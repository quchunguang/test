...
int getAVIFrames(char * fname) {
	...
	int frames = (unsigned char) tempSize[0]
...
int main(int argc, char** argv) {
	...
	int tmpw = (int) cvGetCaptureProperty(g_capture,
			CV_CAP_PROP_FRAME_WIDTH);

	int tmph = (int) cvGetCaptureProperty(g_capture,
	...
	cvCreateTrackbar("Position", "Example2_3", &g_slider_position, frames,
			onTrackbarSlide);
	IplImage* frame;
	frames = 0;
	while (1) {
