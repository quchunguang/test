...
/* user define */
#define S4_ERROR_INPUT_TOO_LONG                 0x00000301                      /** input data length must be less than MAX_DATA_BLOCK_LEN*/ 
#define S4_ERROR_INSUFFICIENT_BUFFER            0x00000302                      /** insufficient out-buffer size*/ 
#define S4_ERROR_INVALID_DATA                   0x00000303                      /** Invalid data package returned*/ 
#define S4_ERROR_OUT_BUFFER                     0x00000304                      /** insufficient out-buffer*/ 
#define S4_ERROR_DEVICE                         0x00000305                      /** OpenS4ByIndex error(device not ready)*/ 
